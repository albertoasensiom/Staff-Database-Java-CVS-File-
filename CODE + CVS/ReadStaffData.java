...
public class ReadStaffData {
	...
	/* ------------------------------QUESTION 1: IMPLEMENT A SORTING ALGORITHM: QUICKSORT------------------------------- */
	...
	public static int partition(Staff[] staffs, int low, int high) {
		...
		//Here I move the elements with same department to the start of the partition. Then I sort them
...
class Staff implements Comparable<Staff> {
	...
	public boolean equals(Object obj) {
		...
		return this.empNo == other.getEmpNo() && this.fName.equals(other.getFName())
				...
				&& this.department.equals(other.getDepartment()) && Float.compare(this.wage, other.getWage()) == 0
